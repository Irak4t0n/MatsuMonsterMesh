...
install: build
install:
	cd badgelink/tools; ./badgelink.sh appfs upload matsumonstermesh "MatsuMonsterMesh" 0 ../../$(BUILD)/application.bin

.PHONY: run
run:
	cd badgelink/tools; ./badgelink.sh start matsumonstermesh
